...
| [**ChromaGuard**](https://github.com/adithya-hmt/chromaguard-hackfusion-2026) | An ESP32 textile-effluent compliance prototype with rule-based classification and an interactive demo. |

## What I work with

- **Product engineering:** TypeScript, React, Node.js, Python, PostgreSQL, and Supabase
- **Mobile and local-first systems:** Android, Kotlin, SQLite, offline workflows, and synchronization
- **AI-assisted software:** agent workflows, MCP integrations, evaluation, and engineering guardrails
- **Developer systems:** Linux, NixOS, GitHub Actions, testing, and release automation
...
**Build clearly. Ship responsibly. Keep learning.**
